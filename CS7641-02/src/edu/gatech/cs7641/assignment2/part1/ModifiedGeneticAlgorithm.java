...
/**
 * Improve on ABAGAIL opt.ga.StandardGeneticAlgorithm.
 * @author Nathaniel Meyer (nathaniel.meyer@gatech.edu)
 * @version 1.0
 */
public class ModifiedGeneticAlgorithm extends OptimizationAlgorithm {
     ...
     */
    public ModifiedGeneticAlgorithm(int populationSize, int toMate, int toMutate, GeneticAlgorithmProblem gap) {
        super(gap);
        this.toMate = toMate;
